...
if __name__ == '__main__':
    ...
    min_dest_num, max_dest_num, min_flow_num, max_flow_num, alpha, min_packet_num = 1, n - 1, 1, 10, 1.2, 10
    dests, flow_num, packet_num = flows.generate(n, min_dest_num, max_dest_num, min_flow_num, max_flow_num,
                                                 alpha, min_packet_num)

    min_start_time, max_start_time, min_interval, max_interval = 0, 5, 2, 5
    ...
    flow_data_file = "backup/vialation-case-1.txt"
